...
private:
    ...
    static void null_res(std::vector<T>& deg) {
        ...
        size_t counter = 0;
        for (auto it = deg.rend(); it != deg.rbegin(); ++it) {
...
int main() {
    std::vector<long long> v1 = {0, 9, 2, -1, 1, 1, 2, 0, 0, 0}, v2={-1, 2, 1, 1, 0, 0, 2},
            v3 = {1, 2, 3}, v4 = {2, 1}, v0 = {0, 0, 0, 0, 0, 0, 0}, v5={0, 0, 0, 0, -2}, v12;
    Polynomial<long long> p1(v1), p2(42), p3, p4(v2.begin()+2, v2.end()), p5(v3), p6(v4),
            p7(v3.rbegin() + 1, v3.rend()), p8(v1.begin(), v1.begin()+7), p0(v0), p10(v5), p12(v12);
    Polynomial<int32_t> a(0), b({1, 2, 3, 0, 0});
    std::cout << "ZERO POLYNOM ";print(a);
